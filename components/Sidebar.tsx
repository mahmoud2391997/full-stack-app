...
const allNavItems: NavItem[] = [
    ...
    {
        name: 'سلسلة التوريد', view: 'SupplyChain', icon: TruckIcon, permission: 'inventory:read',
        children: [
            { name: 'عناصر سلسلة التوريد', view: 'SupplyChain/Items' },
            { name: 'حركات التوريد', view: 'SupplyChain/Movements' },
            { name: 'مخزون التوريد', view: 'SupplyChain/Inventory' },
        ]
    },
    {
