...
export const MOCK_SUPPLY_CHAIN_ITEMS: SupplyChainItem[] = [
  {
    id: 1,
    sku: 'RM-OIL-001',
    gtin: '1234567890123',
    ...
    productName: 'زيت الورد الدمشقي',
    quantity: 500,
    unit: 'g',
    manufacturer: 'Damascus Rose Co.',
    originCountry: 'Syria',
  ...
  },
  {
    ...
    productName: 'زجاجة عطر 50مل (شفاف)',
    quantity: 1000,
    unit: 'pcs',
    manufacturer: 'Kuwait Glass Manufacturing',
    originCountry: 'Kuwait',
    manufactureDate: '2024-03-01',
    currentStatus: 'Delivered',
    transportMode: 'Ground Transport',
    created_at: '2024-03-05T12:00:00Z',
    updated_at: '2024-07-20T09:15:00Z'
  }
];

export const MOCK_SUPPLY_MOVEMENTS: SupplyMovement[] = [
  {
    id: 1,
    supplyId: 1,
    fromBranchId: 5, // Fintas Warehouse
    toBranchId: 4,   // Manufacturing
    type: 'TRANSFER',
    quantity: 100,
    date: '2024-07-25',
    referenceType: 'TRANSFER',
    referenceId: 1001,
    notes: 'Transfer for production order MO-20240728-001',
    createdBy: 1
  },
  {
    id: 2,
    supplyId: 2,
    fromBranchId: 0, // External supplier
    toBranchId: 5,   // Fintas Warehouse
    type: 'IN',
    quantity: 250,
    date: '2024-07-20',
    referenceType: 'PURCHASE',
    referenceId: 1,
    notes: 'New shipment from Cambodia Oud Ltd.',
    createdBy: 3
  },
  {
    id: 3,
    supplyId: 3,
    fromBranchId: 4, // Manufacturing
    toBranchId: 1,   // Arabiva 1
    type: 'OUT',
    quantity: 50,
    date: '2024-07-28',
    referenceType: 'PRODUCTION',
    referenceId: 1,
    notes: 'Finished goods distribution',
    createdBy: 2
  }
];

export const MOCK_SUPPLY_INVENTORY: SupplyInventory[] = [
  {
    id: 1,
    barcode: 1234567890,
    currentStock: 400,
  ...
  },
  {
    ...
    reorderPoint: 50,
    location: 'B-02-003',
    lastUpdated: '2024-07-25T16:45:00Z'
  },
  {
    id: 3,
    barcode: 1234567892,
...
export const MOCK_SUPPLY_ADJUSTMENTS: InventoryAdjustmentLog[] = [
  {
    id: 1,
    date: '2024-07-25',
    branchId: 4,
    ...
    notes: 'Found 100g damaged during quality check'
  },
  {
    id: 2,
    date: '2024-07-20',
